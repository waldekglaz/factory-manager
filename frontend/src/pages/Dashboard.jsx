  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        <div className="gap-2">
          ...
          <a
            ...
            download
            title="Download a copy of the database file"
          >
            Backup DB
          </a>
        </div>
            ...
            <tbody>
              {alerts.outOfStock.map((p) => (
                <tr key={p.id}>
                  ...
                  <td>
                    <button className="btn btn-ghost btn-sm" onClick={() => navigate("/parts")}>
                      Update Stock
                    </button>
                  </td>
                </tr>
      ...
      <Section
        ...
        countColor={inProductionOrders.length > 0 ? "#f59e0b" : undefined}
      >
              ...
              {inProductionOrders.map((o) => {
                ...
                return (
                  <tr key={o.id}>
                    ...
                    <td>{o.quantity}</td>
                    <td>
                      {fmtDate(o.productionEndDate)}
                      {" "}<span className={end.cls}>({end.label})</span>
                    </td>
      ...
      <Section
        ...
        countColor={plannedOrders.length > 0 ? "#3b82f6" : undefined}
      >
              ...
              {plannedOrders.map((o) => {
                ...
                return (
                  <tr key={o.id}>
                    ...
                    <td>{o.quantity}</td>
                    <td>
                      {fmtDate(o.productionStartDate)}
                      {" "}<span className={start.cls}>({start.label})</span>
                    </td>
